<x-layout title="Ideas">
    ...
    <form method="POST" action="/ideas">
        ...
        <div class="col-span-full">
            <label for="description" class="block text-10 font-medium text-white">Enter your Idea</label>
            <p class=" text-sm/6 text-gray-400">Add an idea to your list.</p>
            <div class="mt-2">
            ...
            <p class="text-red-800">{{ $errors->first('description') }}</p>
            @endif  -->      
